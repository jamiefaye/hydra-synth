...
`;
  ...
  function extractMeshFromGltf(gltf, binBuffer, meshIndex, primitiveIndex) {
    ...
    if (!hasAnyUVs) {
      for (let i2 = 0; i2 < verts.length; i2 += 3) {
        const x2 = verts[i2], y = verts[i2 + 1], z = verts[i2 + 2];
  ...
  let ForInStatement$1, FunctionDeclaration$1, RestElement$1, BinaryExpression$1, ArrayExpression$1, Block$1, MethodDefinition;
  ...
  function getAngleWgsl(value, uniformName, uniforms) {
    ...
    uniforms.push({ name: uniformName, type: "f32", value });
...
`;
    ...
    const outputFields = [
      ...
      // Instance ID for fragment shader
    ];
    ...
    const instanceIdCode = useInstancing ? "output.v_instanceId = f32(instanceIdx);" : "output.v_instanceId = 0.0;";
    const ixDefCode = useInstancing ? "let _ix = f32(instanceIdx);" : "let _ix = 0.0;";
    ...
    const fnSignature = useInstancing ? "fn main(input: VertexInput, @builtin(instance_index) instanceIdx: u32) -> VertexOutput" : "fn main(input: VertexInput) -> VertexOutput";
    let wgsl;
    if (has3D) {
      const projectionCode = hasPerspective ? `
      // Perspective projection with aspect ratio correction
...
`;
      ...
      output.position = vec4f(
        ...
        (pos.z * (near + far) + 2.0 * near * far) * rangeInv,
        w
      );` : use3DPos ? "output.position = vec4f(pos.xy, pos.z * 0.1, 1.0);" : "output.position = vec4f(pos, 0.0, 1.0);";
      wgsl = `struct VertexInput {
${inputFields.join("\n")}
};
...
`;
  class SpritePassEntry {
    ...
    reset() {
      ...
      this.spriteGridBuffer = void 0;
      this.spriteBindGroup = void 0;
      this.animation = null;
    }
  }
  ...
  class wgslHydra {
    ...
    async setupSpriteChain(chan, spriteLevel, config) {
      ...
      const blendState = BLEND_MODES$1[spe.blendMode] || BLEND_MODES$1.normal;
    ...
    generateSpriteUniformDeclarations(spe) {
      ...
      Object.keys(uniInfo).forEach((key) => {
        ...
        if (key.startsWith("tex")) {
          uniEntry = new uniformTextureListEntry(spe.chan, i2, key, uniInfo[key]);
...
`;
    ...
    setSpriteValueUniformValues(spe, time) {
      ...
      for (let i2 = 0; i2 < ourUniforms.length; ++i2) {
        ourUniforms[i2].setUniformValues(spe, time);
      }
    }
    ...
    updateVertexUniforms(spe) {
      ...
      for (const u of spe.vertexUniforms) {
        ...
        if (u.type === "f32") {
          ...
          floatData[offset] = typeof v2 === "function" ? v2() : v2;
          offset += 1;
        } else if (u.type === "vec2f") {
...
`;
  ...
  Output$1.prototype.render = function(passes) {
    let pass = passes[0];
    var self2 = this;
  ...
  class HydraSource {
    ...
    initImage(url = "", params) {
      ...
      img.onload = () => {
        ...
        self2.dynamic = false;
        self2.active = true;
        self2.width = img.width;
        self2.height = img.height;
        self2.tex = this.makeTexture({ width: img.width, height: img.height, data: self2.src, ...params });
      };
    }
    ...
    (function(module2, exports$1) {
      !(function(r, t) {
        ...
        function s(r2) {
          ...
          var o2 = n2, i22 = new Float32Array(o2), u2 = 0, f2 = t2, c2 = new Int32Array(o2 + 1);
          c2[0] = 0;
        ...
        function p(r2) {
          ...
          for (var n2 = m({ ampSpectrum: t2 }), o2 = e2.length, i22 = Array(o2), u2 = new Float32Array(o2), f2 = 0; f2 < u2.length; f2++) {
            ...
            for (var c2 = 0; c2 < a22 / 2; c2++) i22[f2][c2] = e2[f2][c2] * n2[c2], u2[f2] += i22[f2][c2];
        ...
        var v2 = Object.freeze({ __proto__: null, amplitudeSpectrum: function(r2) {
          ...
          var i22 = p({ ampSpectrum: t2, melFilterBank: e2, bufferSize: n2 });
          ...
          var t2 = r2.ampSpectrum;
          if ("object" != typeof t2) throw new TypeError();
          var e2 = t2, a22 = l(1, e2), n2 = l(2, e2), o2 = l(3, e2), i22 = l(4, e2);
  ...
  var map$1 = (num, in_min, in_max, out_min, out_max) => {
  ...
  const ArrayUtils = {
    init: () => {
      ...
      Array.prototype.ease = function(ease = "linear") {
        if (typeof ease == "function") {
          this._smooth = 1;
          this._ease = ease;
        } else if (easing$1[ease]) {
          this._smooth = 1;
          this._ease = easing$1[ease];
        }
        return this;
      };
      ...
      Array.prototype.fit = function(low = 0, high = 1) {
        ...
        var newArr = this.map((num) => map$1(num, lowest, highest, low, high));
    ...
    getValue: (arr = []) => ({ time, bpm }) => {
      ...
      if (smooth !== 0) {
        let ease = arr._ease ? arr._ease : easing$1["linear"];
        let _index = index - smooth / 2;
        let currValue = arr[Math.floor(modulo$1(_index, arr.length))];
        let nextValue = arr[Math.floor(modulo$1(_index + 1, arr.length))];
        let t = Math.min(modulo$1(_index, 1) / smooth, 1);
  ...
  const ensure_decimal_dot$1 = (val) => {
    val = val.toString();
    if (val.indexOf(".") < 0) {
      val += ".";
    }
  ...
  function formatArguments$1(transform, startIndex, synthContext) {
    ...
    return defaultArgs.map((input, index) => {
      ...
      if (typedArg.type === "float") typedArg.value = ensure_decimal_dot$1(input.default);
      ...
      if (startIndex < 0) ;
        ...
        if (typedArg.value && typedArg.value.transforms) {
          ...
          typedArg.value = ensure_decimal_dot$1(typedArg.value);
  ...
  function generateGlsl$3(transforms) {
    var shaderParams = {
      uniforms: [],
    ...
    var gen = generateGlsl$2(transforms, shaderParams)("c", "st");
  ...
  function generateInputName(v2, index) {
    return `${v2}_i${index}`;
  }
  function generateGlsl$2(transforms, shaderParams) {
    var generator = (c, uv) => "";
    transforms.forEach((transform, i2) => {
      let inputs = formatArguments$1(transform, shaderParams.uniforms.length);
      inputs.forEach((input) => {
        if (input.isUniform) shaderParams.uniforms.push(input);
      });
      if (!contains$1(transform, shaderParams.glslFunctions)) shaderParams.glslFunctions.push(transform);
      var prev = generator;
      if (transform.transform.type === "src") {
        generator = (c, uv) => `${generateInputs(inputs, shaderParams)(`${c}${i2}`, uv)}
         vec4 ${c} = ${shaderString$1(`${c}${i2}`, uv, transform.name, inputs)};`;
      } else if (transform.transform.type === "color") {
        generator = (c, uv) => `${generateInputs(inputs, shaderParams)(`${c}${i2}`, uv)}
         ${prev(c, uv)}
         ${c} = ${shaderString$1(`${c}${i2}`, `${c}`, transform.name, inputs)};`;
      } else if (transform.transform.type === "coord") {
        generator = (c, uv) => `${generateInputs(inputs, shaderParams)(`${c}${i2}`, uv)}
         ${uv} = ${shaderString$1(`${c}${i2}`, `${uv}`, transform.name, inputs)};
         ${prev(c, uv)}`;
      } else if (transform.transform.type === "combine") {
        generator = (c, uv) => (
          // combining two generated shader strings (i.e. for blend, mult, add funtions)
          `${generateInputs(inputs, shaderParams)(`${c}${i2}`, uv)}
         ${prev(c, uv)}
         ${c} = ${shaderString$1(`${c}${i2}`, `${c}`, transform.name, inputs)};`
        );
  ...
  function generateInputs(inputs, shaderParams) {
    ...
    inputs.forEach((input, i2) => {
      if (input.value.transforms) {
        prev = generator;
        generator = (c, uv) => {
          let ci = generateInputName(c, i2);
          let uvi = generateInputName(`${uv}_${c}`, i2);
          return `vec2 ${uvi} = ${uv};${prev(c, uv)}
         ${generateGlsl$2(input.value.transforms, shaderParams)(ci, uvi)}`;
        };
      }
    });
    return generator;
  }
  function shaderString$1(c, uv, method, inputs) {
    const str = inputs.map((input, i2) => {
      if (input.isUniform) {
        return input.name;
      } else if (input.value && input.value.transforms) {
        return generateInputName(c, i2);
      }
      return input.value;
    }).reduce((p, c2) => `${p}, ${c2}`, "");
    return `${method}(${uv}${str})`;
  }
  function contains$1(object, arr) {
  ...
  GlslSource$1.prototype.addTransform = function(obj) {
    this.transforms.push(obj);
  };
  GlslSource$1.prototype.out = function(_output) {
  ...
  GlslSource$1.prototype.glsl = function() {
    var passes = [];
    var transforms = [];
  ...
  GlslSource$1.prototype.compile = function(transforms) {
    var shaderInfo = generateGlsl$3(transforms, this.synth);
    var uniforms = {};
  ...
  ${Object.values(utilityGlsl$1).map((transform) => {
        return `
            ${transform.glsl}
          `;
      }).join("")}
  ...
  class GeneratorFactory {
    ...
    init() {
      ...
      this.sourceClass = /* @__PURE__ */ (() => {
        return class extends GlslSource$1 {
        };
      })();
...
`;
      ...
      (function(global, factory) {
                ...
                if (line22.errors.length > 0) {
                  ...
                  line22.errors.forEach(function(error) {
                    ...
                    if (token) {
                      ...
                      offset = Math.max(line22.line.indexOf(tokenPat, offset), 0);
                    } else {
                      offset = 0;
                    }
                    push(leftPad("| ", 6));
        ...
        function wrapAttributeState(gl, extensions, limits, stats2, bufferState) {
          ...
          function destroyBuffer(buffer) {
            for (var i22 = 0; i22 < attributeBindings.length; ++i22) {
              var record = attributeBindings[i22];
          ...
          function setVAOEmulated(vao) {
            ...
            if (vao) {
              ...
              for (var i22 = 0; i22 < attributeBindings.length; ++i22) {
                var binding = attributeBindings[i22];
                if (binding.buffer) {
          ...
          REGLVAO.prototype.bindAttrs = function() {
            ...
            for (var i22 = 0; i22 < attributes.length; ++i22) {
              var attr = attributes[i22];
              if (attr.buffer) {
                gl.enableVertexAttribArray(i22);
          ...
          function createVAO(_attr) {
            ...
            function updateVAO(attributes) {
              ...
              for (var i22 = 0; i22 < attributes.length; ++i22) {
                var spec = attributes[i22];
                var rec = nattributes[i22] = new AttributeRecord();
          ...
          function emitUniforms(env, scope, args, uniforms, filter) {
            ...
            for (var i2 = 0; i2 < uniforms.length; ++i2) {
              ...
              if (infix.charAt(0) === "M") {
                ...
                scope(loop(unroll, function(i22) {
                  return Array.isArray(VALUE) ? VALUE[i22] : VALUE + "[" + i22 + "]";
                }));
              } else {
  ...
  const GeneratorFunction = Object.getPrototypeOf(async function* () {
  }).constructor;
  ...
  async function createHydra$1({
    ...
    if (precision && precisionOptions.includes(precision.toLowerCase())) {
      ...
      const isIOS = typeof navigator !== "undefined" && ((/iPad|iPhone|iPod/.test(navigator.platform) || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) && !window.MSStream);
    ...
    if (useWGSL) {
      ...
      hydra.generator = new GeneratorFactory({
    ...
    hydra._destroy = function() {
      ...
      if (hydra.wgslHydra) {
        for (let i2 = 0; i2 < hydra.wgslHydra.numChannels; i2++) {
          hydra.wgslHydra.clearSpriteChains?.(i2);
        }
        if (hydra.o) {
          hydra.o.forEach((output) => {
            if (output.textures) {
  ...
  function initSources(hydra, numSources) {
    for (let i2 = 0; i2 < numSources; i2++) {
      const s = new HydraSource({
        regl: hydra.regl,
        // undefined in WebGPU mode
        wgsl: hydra.wgslHydra,
        // undefined in WebGL mode
        hydraSynth: hydra,
        pb: hydra.pb,
        width: hydra.width,
        height: hydra.height,
  ...
  function createTick(hydra) {
    return function tick(dt) {
      hydra.synth.time += dt * 1e-3 * hydra.synth.speed;
      hydra.synth.stats.fps = Math.round(1e3 / dt);
...
`;
  ...
  async function createHydra(options = {}) {
    const hydra = await createHydra$1(options);
    install(hydra);
    return hydra;
  }
  async function replaceHydra(existingHydra = null, options = {}) {
    if (typeof window !== "undefined") {
      if (window.__hydraVertexWebGL) {
        console.error("[hydra-vertex-webgpu] ⚠️ WebGL vertex extension already loaded!");
        console.error("[hydra-vertex-webgpu] Mixing WebGL and WebGPU extensions causes errors.");
  ...
  exports2.cone = cone;
  exports2.createHydra = createHydra;
  exports2.cube = cube;
  exports2.cylinder = cylinder;
  exports2.generateVertexGlsl = generateVertexGlsl;
  exports2.generateVertexWgsl = generateVertexWgsl;
  exports2.getPassthroughVertexWgsl = getPassthroughVertexWgsl;
  ...
  exports2.replaceHydra = replaceHydra;
  exports2.ring = ring;
...
//# sourceMappingURL=vertex-webgpu.umd.js.map
