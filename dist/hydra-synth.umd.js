(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["hydra-synth"] = {}));
  ...
  var inherits_browserExports = requireInherits_browser();
  ...
  class HydraSource {
    ...
    initVideo(url = "", params) {
      ...
      vid2.addEventListener("loadeddata", () => {
        this.src = vid2;
        this.width = vid2.videoWidth;
        this.height = vid2.videoHeight;
        vid2.play();
    ...
    (function(module2, exports3) {
      (function(global, factory) {
        ...
        function wrapShaderState(gl, stringStore, stats2, config) {
          var fragShaders = {};
          var vertShaders = {};
          function ActiveInfo(name, id2, location2, info) {
            this.name = name;
            this.id = id2;
...
`;
  ...
  class wgslHydra {
    constructor(hydra, canvas2, numChannels = 4) {
      this.hydra = hydra;
      this.canvas = canvas2;
      this.context = this.canvas.getContext("webgpu");
      this.aspect = this.canvas.width / this.canvas.height;
...
`;
  ...
  function requireDefaultTraveler() {
    ...
    (function(exports3) {
      (function(global, factory) {
      ...
      })(defaultTraveler, function(exports22) {
        ...
        exports22.default = {
          ...
          BlockStatement: function BlockStatement2(node, state) {
            ...
            if (statements != null) {
              for (var i2 = 0, length = statements.length; i2 < length; i2++) {
                this.go(statements[i2], state);
              }
            }
          },
          ...
          FunctionDeclaration: FunctionDeclaration2 = function FunctionDeclaration22(node, state) {
            ...
            if (params != null) {
              for (var i2 = 0, length = params.length; i2 < length; i2++) {
          ...
          TemplateLiteral: function TemplateLiteral(node, state) {
            ...
            for (var i2 = 0, length = expressions.length; i2 < length; i2++) {
              this.go(expressions[i2], state);
            }
  ...
  function requireAttachComments() {
    ...
    (function(exports3) {
      (function(global, factory) {
        {
          factory(exports3, requireDefaultTraveler());
        }
      })(attachComments, function(exports22, _defaultTraveler) {
        exports22.__esModule = true;
        exports22.default = function(node, comments) {
        ...
        function attachComments2(parent, children, findHeadingComments, state, traveler) {
          ...
          if (comment != null) {
            if (children == null || children.length === 0) {
              ...
              for (var i2 = 0, length = children.length; comment != null && i2 < length; i2++) {
  ...
  function requireAstravel() {
    ...
    (function(exports3) {
      (function(global, factory) {
        {
          factory(exports3, requireDefaultTraveler(), requireAttachComments());
        }
      })(astravel, function(exports22, _defaultTraveler, _attachComments) {
        exports22.__esModule = true;
        exports22.makeTraveler = exports22.attachComments = exports22.defaultTraveler = void 0;
        var _defaultTraveler2 = _interopRequireDefault(_defaultTraveler);
        ...
        exports22.defaultTraveler = _defaultTraveler2.default;
        exports22.attachComments = _attachComments2.default;
        exports22.makeTraveler = makeTraveler;
      });
    })(astravel);
    return astravel;
  }
  ...
  class SourceProxy {
    ...
    openSource() {
      const self2 = this;
      if (this.kind === "webcam") {
        Webcam(this.mediaAddr).then((response) => {
          self2.src = response.video;
          self2.dynamic = true;
          self2.offCan = new OffscreenCanvas(640, 480);
          self2.offCTX = self2.offCan.getContext("2d");
          self2.open = true;
        }).catch((err) => console.log("could not get camera", err));
        ...
        vid2.addEventListener("loadeddata", () => {
          self2.src = vid2;
          vid2.play();
          self2.offCan = new OffscreenCanvas(vid2.videoWidth, vid2.videoHeight);
          self2.offCTX = self2.offCan.getContext("2d");
          self2.dynamic = true;
          self2.open = true;
        });
        vid2.src = this.mediaAddr;
        ...
        img.onload = () => {
          self2.src = img;
          self2.dynamic = false;
          self2.offCan = new OffscreenCanvas(img.width, img.height);
          self2.offCTX = self2.offCan.getContext("2d");
          self2.dynamic = false;
          self2.open = true;
        };
        ...
        Screen().then(function(response) {
          self2.src = response.video;
          self2.offCan = new OffscreenCanvas(vid.videoWidth, vid.videoHeight);
          self2.offCTX = self2.offCan.getContext("2d");
          self2.dynamic = true;
          self2.open = true;
        }).catch((err) => console.log("could not get screen", err));
    ...
    sendFrame() {
      ...
      this.bgWorker.proxyFrameUpdate(this.sourceX, transfer(imgBM, [imgBM]));
      this.updates++;
    }
  }
  class BGSynth {
    ...
    async openWorker() {
      if (!BGRWorker) {
        BGRWorker = wrap(new Worker(new URL(
          /* @vite-ignore */
          "" + (typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__dirname + "/assets/BGRWorker.js").href : new URL("assets/BGRWorker.js", typeof document === "undefined" ? location.href : document.currentScript && document.currentScript.tagName.toUpperCase() === "SCRIPT" && document.currentScript.src || document.baseURI).href),
          typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("hydra-synth.umd.js", document.baseURI).href
        ), { type: "module" }));
      }
      this.bgWorker = await new BGRWorker(this.useWGSL, this.useAudio);
      if (this.directToCanvas) {
        let offscreen = this.canvas;
        await this.bgWorker.setTransferCanvas(transfer(offscreen, [offscreen]));
      }
      await this.bgWorker.openHydra();
      await this.bgWorker.registerCallback("frame", proxy(this.frameReadyFromWorker.bind(this)));
      await this.bgWorker.registerCallback("proxy", proxy(this.requestProxySource.bind(this)));
      await this.bgWorker.registerCallback("setaudio", proxy(this.setAudio.bind(this)));
      if (!this.directToCanvas) {
    ...
    tickSourceProxies() {
      for (let i2 = 0; i2 < this.activeSourceProxies.length; ++i2) {
        this.activeSourceProxies[i2].sendFrame();
      }
      if (this.audioProxy) {
  ...
  class AudioProxy {
    ...
    setValue(what, toValue) {
      ...
      } else if (what === "setCutoff") {
        this.a.setCutoff(toValue);
      } else if (what === "setScale") {
        this.a.setScale(toValue);
      } else if (what === "setSmooth") {
  ...
  class MsgBrokerClass {
    constructor() {
      this.worker = new SharedWorker(new URL(
        /* @vite-ignore */
        "" + (typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__dirname + "/assets/MeetupWorker.js").href : new URL("assets/MeetupWorker.js", typeof document === "undefined" ? location.href : document.currentScript && document.currentScript.tagName.toUpperCase() === "SCRIPT" && document.currentScript.src || document.baseURI).href),
        typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("hydra-synth.umd.js", document.baseURI).href
      ), { type: "module" });
      this.broker = wrap(this.worker.port);
    }
    async registerCallback(name, cb) {
      await this.broker.registerCallback(name, proxy(cb));
    }
    ...
    async locateTarget() {
      let list2 = await this.broker.listForKind(this.otherKind);
      if (list2.length > 0) {
        this.targetView = list2[list2.length - 1];
  ...
  exports2.BGSynth = BGSynth;
  exports2.Hydra = HydraRenderer;
  exports2.openMsgBroker = openMsgBroker;
